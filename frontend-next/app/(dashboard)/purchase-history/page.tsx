...
export default function PurchaseHistoryPage() {
  ...
  const exportToDropbox = async () => {
    ...
    try {
      const res = await fetch(apiUrl('/api/v1/workflows/export-dropbox/purchases'), {
        method: 'POST',
        headers: authHeaders(),
      });
      const json = await res.json();
      ...
      <div className="animate-fadeIn">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">C-Auto 구매입력 기록</p>
          </div>
      ...
      <div className="animate-fadeIn">
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center">
            ...
            <p className="text-sm text-slate-500">구매 기록이 없습니다</p>
