...
const MENU_ITEMS: { key: string; label: string; section: string }[] = [
  ...
  { key: '/warehouse-portal?wh=mk', label: 'MK물류', section: '창고 포털' },
  { key: '/warehouse-portal?wh=mansuk', label: '만석물류', section: '창고 포털' },
  { key: '/warehouse-portal?wh=wellrise', label: '웰라이즈', section: '창고 포털' },
  { key: '/warehouse-portal?wh=ecofarm', label: '에코스팜', section: '창고 포털' },
  { key: '/warehouse-portal?wh=playground', label: '플레이그라운드', section: '창고 포털' },
  { key: '/warehouse-portal?wh=kpros', label: '케이프로스', section: '창고 포털' },
